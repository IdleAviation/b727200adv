...
class PFDComponent extends DisplayComponent {
    render() {
        return (FSComponent.buildComponent("div", { class: 'pfd-component' }, "Hello World!"));
    }
}
...
class PFD extends BaseInstrument {
    ...
    connectedCallback() {
        ...
        FSComponent.render(FSComponent.buildComponent(PFDComponent, null), document.getElementById('InstrumentContent'));
    }
}
